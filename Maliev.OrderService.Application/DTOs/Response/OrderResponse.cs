namespace Maliev.OrderService.Application.DTOs.Response
{
    ...
    public class OrderResponse
    {
        ...
        /// <summary>Gets or sets the order version (xmin value for optimistic concurrency control).</summary>
    ...
    /// <summary>3D printing service-specific attributes.</summary>
    ...
    /// <summary>CNC machining service-specific attributes.</summary>
    ...
    /// <summary>Sheet metal service-specific attributes.</summary>
    ...
    /// <summary>3D scanning service-specific attributes.</summary>
    ...
    /// <summary>3D design service-specific attributes.</summary>
