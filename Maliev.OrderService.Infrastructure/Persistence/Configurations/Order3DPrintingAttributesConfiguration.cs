...
{
    /// <summary>EF Core configuration for <see cref="Order3DPrintingAttributes"/>.</summary>
    internal sealed class Order3DPrintingAttributesConfiguration : IEntityTypeConfiguration<Order3DPrintingAttributes>
    {
